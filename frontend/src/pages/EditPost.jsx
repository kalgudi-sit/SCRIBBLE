        ...
        <form className="w-full flex flex-col space-y-4 md:space-8 mt-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              <button
                onClick={addCategory}
                className="bg-black text-white px-4 py-2 font-semibold cursor-pointer outline-none rounded-lg hover:bg-blue-600"
              >
                Add
              </button>
            </div>
            ...
            <div className="flex mt-3 px-4">
              {categories?.map((category, index) => {
                return (
                  <div
                    key={index}
                    className="flex justify-center items-center space-x-2 mr-4 bg-gray-400 px-2 py-1 rounded-md"
                  >
                    <p>{category}</p>
                    <p
